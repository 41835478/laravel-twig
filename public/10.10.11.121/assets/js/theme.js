...
;(function () {
    ...
    function t(n, t, r) {
        for (var e = -1, u = n.length; ++e < u;) {
            var o = n[e], i = t(o);
            if (null != i && (c === an ? i === i : r(i, c))) var c = i, f = o
        }
        return f
    }
    ...
    function m(n, t, r, e, u, o) {
        var i = Pn(n), f = Pn(t), a = "[object Array]", l = "[object Array]";
        i || (a = kn.call(n), "[object Arguments]" == a && (a = "[object Object]")), f || (l = kn.call(t), "[object Arguments]" == l && (l = "[object Object]"));
        var p = "[object Object]" == a && !c(n), f = "[object Object]" == l && !c(t);
        return !(l = a == l) || i || p ? 2 & u || (a = p && En.call(n, "__wrapped__"),
            f = f && En.call(t, "__wrapped__"), !a && !f) ? l ? (o || (o = []), (a = J(o, function (t) {
            return t[0] === n
    ...
    function F(n, t, r, e) {
        ...
        for (var u = -1, o = t.length; ++u < o;) {
            var i = t[u], c = e ? e(r[i], n[i], i, r, n) : n[i], f = r, a = f[i];
    ...
    function R(n) {
        return V(function (t, r) {
            var e = -1, u = r.length, o = u > 1 ? r[u - 1] : an, o = typeof o == "function" ? (u--, o) : an;
            for (t = Object(t); ++e < u;) {
                var i = r[e];
                i && n(t, i, e, o)
            }
    ...
    function I(n, t, r, e, u, o) {
        var i = -1, c = 1 & u, f = n.length, a = t.length;
    ...
    function q(n, t, r, e, u, o) {
        var i = 2 & u, c = en(n), f = c.length, a = en(t).length;
    ...
    function C(n) {
        var t = n && n.constructor, t = Q(t) && t.prototype || xn;
        return n === t
    }
    ...
    function en(n) {
        ...
        var r, e = z(n), u = !!e, e = e || [], o = e.length;
    ...
    function fn(t, r, e) {
        ...
        var i = X(e) && "chain" in e ? e.chain : true, c = Q(t);
    ...
    var an, ln = 1 / 0, pn = /[&<>"'`]/g, sn = RegExp(pn.source), hn = /^(?:0|[1-9]\d*)$/,
        vn = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "`": "&#96;"},
        yn = {"function": true, object: true}, _n = yn[typeof exports] && exports && !exports.nodeType ? exports : an,
        gn = yn[typeof module] && module && !module.nodeType ? module : an, bn = gn && gn.exports === _n ? _n : an,
        jn = o(yn[typeof self] && self), mn = o(yn[typeof window] && window), dn = o(yn[typeof this] && this),
        wn = o(_n && gn && typeof global == "object" && global) || mn !== (dn && dn.window) && mn || jn || dn || Function("return this")(),
        On = Array.prototype, xn = Object.prototype, En = xn.hasOwnProperty, An = 0, kn = xn.toString, Nn = wn._,
        Sn = wn.Reflect, Tn = Sn ? Sn.f : an, Fn = Object.create, Rn = xn.propertyIsEnumerable, Bn = wn.isFinite,
        Dn = Object.keys, In = Math.max, $n = function (n, t) {
            return function (r, e) {
                if (null == r) return r;
                if (!L(r)) return n(r, e);
    ...
    Tn && !Rn.call({valueOf: 1}, "valueOf") && (w = function (n) {
        n = Tn(n);
        for (var t, r = []; !(t = n.next()).done;) r.push(t.value);
        return r
    });
    var zn = A("length"), Cn = V(function (t, r) {
        ...
        return h(n, Vn(t) || 0, r)
    }), Pn = Array.isArray, Un = Number, Vn = Number, Hn = R(function (n, t) {
        F(t, en(t), n)
    }), Kn = R(function (n, t) {
        F(t, un(t), n)
    ...
    l.prototype = s(a.prototype), l.prototype.constructor = l, a.assignIn = Kn, a.before = U, a.bind = Gn, a.chain = function (n) {
        ...
        return t = d(t), O(O(n, function (n, e, u) {
            ...
            n:{
                ...
                var e = t.a;
                if (r !== e) {
                    var u = null === r, o = r === an, i = r === r, c = null === e, f = e === an, a = e === e;
    ...
    }, a.reduce = P, a.result = function (n, t, r) {
    ...
    }(), {chain: false}), a.VERSION = "4.5.1", $n("pop join replace reverse split push shift sort splice unshift".split(" "), function (n) {
        var t = (/^(?:replace|split)$/.test(n) ? String.prototype : On)[n],
            r = /^(?:push|sort|unshift)$/.test(n) ? "tap" : "thru", e = /^(?:pop|join|replace|shift)$/.test(n);
    ...
    }, (mn || jn || {})._ = a, typeof define == "function" && typeof define.amd == "object" && define.amd ? define(function () {
        return a
...
!function (a) {
    a.flexslider = function (b, c) {
        ...
        var j, e = d.vars.namespace, f = window.navigator && window.navigator.msPointerEnabled && window.MSGesture,
            g = ("ontouchstart" in window || f || window.DocumentTouch && document instanceof DocumentTouch) && d.vars.touch,
            h = "click touchend MSPointerUp", i = "", k = "vertical" === d.vars.direction, l = d.vars.reverse,
            m = d.vars.itemWidth > 0, n = "fade" === d.vars.animation, o = "" !== d.vars.asNavFor, p = {}, q = !0;
...
(function (o) {
    ...
    o.zoom = function (t, n, e, i) {
        ...
        return this.each(function () {
            var e, i = o.extend({}, t, n || {}), u = i.target || this, c = this, a = o(c),
                m = document.createElement("img"), l = o(m), r = "mousemove.zoom", s = !1, f = !1;
...
theme.Header = (function () {
    ...
    Header.prototype = _.assignIn({}, Header.prototype, {
        init: function () {
            ...
            cache.$mobileSublistTrigger.on('click.mobileSublistTrigger', function (evt) {
                var $el = $(this);
            ...
            cache.$hasDropdownItem.on('click.hasDropdownItem', function (evt) {
                var $el = $(this);

                if (!$el.hasClass(self.selectors.showDropdownClass) && timber.vars.isTouch) {
                    evt.preventDefault();
        ...
        menuOpen: function () {
            ...
            cache.$mobileNavTrigger.attr('data-menu-state', 'open');
        ...
        menuClose: function () {
            cache.$mobileNavTrigger.attr('data-menu-state', 'close');
